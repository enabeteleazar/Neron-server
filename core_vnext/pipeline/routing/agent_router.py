...
class LLMConfig:
    provider:    str        = "ollama"
    model:       str        = "llama3.2"
    # Résolution de l'URL Ollama : NERON_OLLAMA_URL > OLLAMA_HOST > localhost:11434
    base_url:    str        = field(
        default_factory=lambda: (
            os.getenv("NERON_OLLAMA_URL")
...
class AgentRouter:
    ...
    def __init__(
        ...
        self.skills   = skills
        # Construit LLMConfig depuis settings si non fourni explicitement
