"""Normalisation de texte francais (STT, intent matching).

Module pur, sans dependance a une plateforme — extrait de
`core.pipeline.nlp.french_normalizer` vers le noyau partage (Phase 2C).
"""
