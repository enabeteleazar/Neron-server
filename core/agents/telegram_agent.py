...
from server.core.constants import CODE_KEYWORDS
from server.core.agents.base_agent import get_logger
from server.core.agents.watchdog_agent import get_anomalies, get_health_score, get_status
from server.core.config import settings
from server.core.tools.twilio_tool import call as twilio_call
...
async def cmd_status(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        from server.core.modules.scheduler import get_jobs
        jobs      = get_jobs()
